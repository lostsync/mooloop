...
- Notes: Parameter descriptors and the modulation design; seven of the
  ...
  ML-P8, DS-01 and modulator-module plans; `scripts/antibox` and
  `scripts/slint-sketch`; `docs/WIDGET_INVENTORY.md`; and the September 2026
  documentation audit. Longer accounts of most of this are in
