...
- **`Session::reset_channel_source` rewrites the name from the index**, so
  ...
  `docs/plans/archive/interface-iteration/03-channel-identity.md` rather than here.
...
- **Channel names and colours** -- already fully planned in
  `docs/plans/archive/interface-iteration/03-channel-identity.md`.
- **Pattern rename** -- already works. No action.
- **Pattern colour** -- folded into `docs/plans/archive/interface-iteration/03-channel-identity.md`,
