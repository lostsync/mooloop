...
| Plan | State |
| --- | --- |
| `poly-synth-v2/` | **In progress.** ML-P8 steps 02-05 in; 06 started (outlets declared and published, not yet routable); 07 after it. `origin/feat/mlp8-mod` is stale: it carried step 04's WIP, which has landed. |
