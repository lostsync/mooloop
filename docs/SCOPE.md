...
**Note it is not the same item as the master safety limiter.** A bus
compressor is a musical device; a safety limiter is engineering. Both are in
...
- **Item 5 splits.** MIDI recording is in; audio recording follows audio input
  ...
  `plans/archive/audio-recording/`, whose step 01 argues that the executor's input
...
| Thread | State |
| --- | --- |
| **The mixer section at a good stopping point** | **Reached 2026-09-22.** It stood at *"almost"*: the console pass closed 2026-09-11 and was played on headphones the same day, and the studio listening pass was the outstanding piece. That pass was closed on 2026-09-22 on Adam's instruction to treat outstanding listening passes as done with nothing heard (MOO-166). |
...
the decode path, and it **landed on 2026-09-15** (`plans/archive/midi-control/`). A
