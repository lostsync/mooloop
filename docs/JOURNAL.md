...
This is a narrative of development state up to 12:28 PM on August 23.
...
**Hardcoded constants drift; derived ones don't.** The 758px viewport, the 220px pattern strip with 190px of hole, the fixed 5px note edge zone that ate a minimum-width note, the forwarded-command threshold of 29 that had overcounted the baseline. Every one was correct on the day it was written.
