...
mod tests {
    use super::*;
    // The saturation stages moved to `shaper` (MOO-144); their tests stay
    // beside the filters they were voiced with.
    use crate::shaper::{apply_drive, soft_ceiling, PreDrive, DRIVE_REFERENCE_LINEAR, VOICE_CEILING};
