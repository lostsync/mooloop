...
use crate::{
    DeviceKind, EnvTrigger, GlideMode, LfoParams, LfoWave, LoopMode, MonoSynthParams, Ml1Params,
...
const ML1_VOICE_DESCRIPTORS: [ParamDescriptor; 8] = [
...
static ML1_DESCRIPTORS: [ParamDescriptor; 32] = concat_ml1(
