...
use crate::{
    ...
    ModRack, MonoSynthParams, MonoV2Params, NoteEvent, NoteId, ParamAddr, PlaybackMode, PointId,
...
pub enum EngineCommand {
    ...
    /// Replace a channel's v2 mono synth parameter set.
    SetChannelMonoV2Params {
        channel: u8,
        params: MonoV2Params,
    },
