...
const GLOBAL_DESCRIPTORS: [ParamDescriptor; 6] = [
    ...
    ParamDescriptor {
        ...
        curve: ParamCurve::Stepped(MAX_CHOKE_GROUP as u16 + 1),
        default: 0.0,
    },
...
const TONE_DESCRIPTORS: [ParamDescriptor; 7] = [
    ...
    ParamDescriptor {
        ...
        curve: ParamCurve::Stepped(DS01_MAX_PARTIALS as u16),
        default: 1.0,
    },
...
const BURST_DESCRIPTORS: [ParamDescriptor; 5] = [
    ParamDescriptor {
        ...
        curve: ParamCurve::Stepped(DS01_MAX_REPEATS as u16),
        default: 1.0,
    },
...
const SHAPE_DESCRIPTORS: [ParamDescriptor; 5] = [
    ...
    ParamDescriptor {
        ...
        curve: ParamCurve::Stepped(DS01_BITS_TRANSPARENT as u16),
...
const MATRIX_DESCRIPTORS: [[ParamDescriptor; MATRIX_ROW_WIDTH as usize]; DS01_MATRIX_ROWS] = [
    [
        stepped(
            ...
            "Row 1 src",
            Ds01ModSource::ALL.len() as u16,
            0.0,
        ),
        stepped(
            matrix_param(0, MATRIX_OFFSET_DEST),
            "Row 1 dest",
            DS01_DESTINATIONS as u16,
            0.0,
        ),
