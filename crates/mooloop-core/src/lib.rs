...
pub use effect::{
    ...
    ModulationMode, ModulationParams, ReverbMaterial, ReverbParams, ReverbShape, BITCRUSH_PARAM_BITS, BITCRUSH_PARAM_DOWNSAMPLE,
    ...
    MODULATION_PARAM_TONE, REVERB_PARAM_CAPTURE_X,
